...
```shell script
./mvnw compile quarkus:dev -Dquarkus.mongodb.connection-string={mongodb_url}
```
...
```shell script
./mvnw package -Dquarkus.mongodb.connection-string={mongodb_url}
```
...
You can then execute your native executable with: `./target/ifs-base-application-1.0.0-SNAPSHOT-runner`
